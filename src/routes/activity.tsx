      ...
      {emailed && (
        <section className="grid gap-6 py-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <div className="mt-5 rounded-xl border border-edge bg-panel p-5">
              <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-steel">
                inbox · your ai travel agent
              </p>
              <p className="mt-3 text-base font-semibold">We found a flight for you ✈️</p>
              <div className="mt-4 font-mono text-sm">
                <div className="flex justify-between py-1.5">
                  <span className="text-steel">Flight</span>
                  <span className="text-ink">
                    {matchedFlight.airline} · direct
                  </span>
                </div>
                <div className="flex justify-between py-1.5">
                ...
                <div className="flex justify-between py-1.5">
                  <span className="text-steel">You save</span>
                  <span className="text-mint">${trip.budget - matchedFlight.price}</span>
                </div>
              ...
              <Link
                to="/booking"
                className="chrome bevel mt-5 block rounded-lg py-3 text-center font-mono text-sm font-bold uppercase tracking-[0.12em] text-void"
              >
                Confirm &amp; book
              </Link>
            </div>
          ...
          <div className="lg:col-span-7">
            ...
            <ol className="mt-3 space-y-2 font-mono text-[13px]">
              ...
              <li className="flex items-center gap-3 rounded-lg bg-mint/10 px-3 py-2.5 font-bold text-mint">
                <span>✓</span>Notification sent
              </li>
            </ol>
          </div>
        </section>
